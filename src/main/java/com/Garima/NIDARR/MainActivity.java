...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (permissionCheck != PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission (MainActivity.this,
            ...
            heading.setText("NIDARR needs access to");
            ...
            checkbox.setText("");
            checkBoxtext.setText(("I accept the DECLARATION POLICY of the app"));
            ...
            btn_okay.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(checkbox.isChecked ()) {
                        ...
                        Toast.makeText (MainActivity.this,"Please accept the condition",Toast.LENGTH_LONG).show ();
        ...
        shareBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               try {
                    ...
                    shareIntent.putExtra(Intent.EXTRA_SUBJECT, "NIDARR");
                    String shareMessage= "Hii,I am garima mehra gifting a token of safety to all the females in my society as \n\n*NIDARR* solves a very heart wrenching problem of our civilisation, *Women's Safety*. \n\nJust *download*,start using, and spread the app \n\nSo that any *female* related to you can feel safer and empowered in this world. \n\nDownload NIDARR at:-\n";
